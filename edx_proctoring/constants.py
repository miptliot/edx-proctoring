...
EXAM_SESSION_COOKIE_LIFETIME_HOURS = (
    settings.PROCTORING_SETTINGS['EXAM_SESSION_COOKIE_LIFETIME_HOURS'] if
    'EXAM_SESSION_COOKIE_LIFETIME_HOURS' in settings.PROCTORING_SETTINGS
    else getattr(settings, 'EXAM_SESSION_COOKIE_LIFETIME_HOURS', 12)
)
