...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('exam', models.OneToOneField(related_name='proctored_exam_params', primary_key=True, serialize=False,
                                              to='edx_proctoring.ProctoredExam')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('attempt', models.OneToOneField(related_name='proctoring_service', primary_key=True, serialize=False,
                                                 to='edx_proctoring.ProctoredExamStudentAttemptHistory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('attempt', models.OneToOneField(related_name='proctoring_service', primary_key=True, serialize=False,
                                                 to='edx_proctoring.ProctoredExamStudentAttempt')),
                ('service', models.CharField(max_length=255)),
            ],
            options={
